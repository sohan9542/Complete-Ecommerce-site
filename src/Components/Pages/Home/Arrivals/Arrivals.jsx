            ...
            <div className="bg-white">``
                <div className="max-w-2xl mx-auto px-5 sm:py-12
                 sm:px-6 lg:max-w-7xl lg:px-8">
                    <h1 className="text-4xl font-medium text-center pb-2 tracking-tight text-blk-txt">Top Products</h1>
                    ...
                    <div className="flex justify-center items-center">
                        <Link to="/shop" className="text-center my-4 bg-new text-white px-3 ease-linear rounded py-2 transition delay-100 hover:bg-primary-txt">Load More</Link>
                    </div>
                </div>
